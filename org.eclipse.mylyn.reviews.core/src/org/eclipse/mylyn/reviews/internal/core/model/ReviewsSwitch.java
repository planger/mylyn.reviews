...
public class ReviewsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ReviewsPackage.EMF_MODEL_LOCATION: {
			IEmfModelLocation emfModelLocation = (IEmfModelLocation) theEObject;
			T result = caseEmfModelLocation(emfModelLocation);
			if (result == null)
				result = caseLocation(emfModelLocation);
			if (result == null)
				result = caseIndexed(emfModelLocation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseEmfModelLocation(IEmfModelLocation object) {
		return null;
	}
